...
const concreteBenefits = [
  {
    title: "Mehr Anfragen ohne zusaetzlichen Technikaufwand",
    description:
      "Ihre Website unterstuetzt Ihren Betrieb im Hintergrund, waehrend Sie sich auf Ihr Tagesgeschaeft konzentrieren.",
  },
  {
    title: "Mehr Vertrauen beim ersten Klick",
    description:
      "Ein professioneller Auftritt entscheidet oft darueber, ob ein Interessent anruft oder weitersucht.",
  },
  {
    title: "Bessere Auffindbarkeit in Ihrer Region",
    description:
      "Ihr Betrieb wird dort sichtbar, wo Kunden tatsaechlich suchen: bei Google, lokal und mobil.",
  },
  {
        ...
        <ScrollReveal>
          <div className="max-w-3xl mb-8 sm:mb-10 lg:mb-12">
            ...
            <p className="text-muted-foreground font-body text-lg sm:text-xl leading-relaxed mb-4">
              Eine gute Handwerker-Website sorgt dafuer, dass Interessenten in wenigen Sekunden verstehen, wer Sie sind, was Sie anbieten, warum man Ihnen vertrauen kann und wie man Sie direkt erreicht.
            </p>
        ...
        <ScrollReveal>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-xl neu-surface-soft p-4 sm:p-5 mb-7 sm:mb-8">
            <div>
              ...
              <h3 className="font-display text-2xl sm:text-3xl leading-tight">Klare Vorteile fuer Ihren Betrieb</h3>
            </div>
